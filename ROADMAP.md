...
- [x] **Fase 4.1 — Validación de Conectividad Móvil y RTC DS1307 en Banco:**
  ...
  - ✅ **App Baliza v2.8 Liberada:** Temas Light y Night corregidos para forzar texto negro y alto contraste en cualquier marca de teléfono/ROM, sesión Bluetooth persistente, auto-lectura, auto-verificación, auto-reconexión y panel de **Test de Luz Inmediato (2 Minutos)** con apagado manual.
