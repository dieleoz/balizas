...
- [x] **Fase 4.1 — Validación de Conectividad Móvil y RTC DS1307 en Banco:**
  ...
  - ✅ **App Baliza v2.7 Liberada:** Login rediseñado con cajas de texto contrastadas y etiquetas visibles para cualquier modelo de teléfono/ROM, sesión Bluetooth persistente, auto-lectura, auto-verificación, auto-reconexión y panel de **Test de Luz Inmediato (2 Minutos)** con apagado manual.
