...
- [x] **Fase 4.1 — Validación de Conectividad Móvil y RTC DS1307 en Banco:**
  ...
  - ✅ **App Baliza v2.9 Liberada:** Branding corporativo oficial **IT vial s.a.s.** (ícono naranja con la «t», nombre **IT Vial**, barra superior y login con logo), temas Light/Night blindados, sesión persistente, auto-lectura, auto-verificación y panel de **Test de Luz Inmediato (2 Minutos)** con apagado manual.
