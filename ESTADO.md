...
* App móvil Android modernizada y empaquetada como **`Baliza_v3.2.apk`** (nombre exacto **`BALIZA IT VIAL 30`**, botón de **1-Toque para Horario Escolar Oficial**, branding **IT vial s.a.s.** con ícono naranja de la «t», login responsive con banner, temas Light/Night de alto contraste y **Panel de Diagnóstico con Test de Luz Inmediato de 2 Minutos**).
