...
* App móvil Android modernizada y empaquetada como **`Baliza_v2.7.apk`** (layout responsive, login 100% visible con bordes contrastados para cualquier marca/tema, permisos Android 12+, comunicación ISO-8859-1, sesión persistente, auto-lectura y **Panel de Diagnóstico con Test de Luz Inmediato de 2 Minutos**).
