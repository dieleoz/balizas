...
* App móvil Android modernizada y empaquetada como **`Baliza_v2.6.apk`** (layout responsive, permisos Android 12+, comunicación ISO-8859-1, sesión persistente, auto-lectura, auto-reconexión y **Panel de Diagnóstico con Test de Luz Inmediato de 2 Minutos**).
