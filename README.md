...
| ✅ | **App Móvil v2.9 Liberada**: Branding corporativo oficial **IT vial s.a.s.** integrado (ícono naranja con la «t», banner en login, barra superior con logo y nombre **IT Vial**), panel de **Test de Luz Inmediato (2 Min)** y botón de acceso responsivo | `Baliza_v2.9.apk` |
...
> * **App Android:** [`1 Firmware/Baliza_v2.9.apk`](1%20Firmware/Baliza_v2.9.apk)
