	...
	; Compiler options:
	;
	; --std=c99 --outdir=D:\@Proyect\Baliza\1 Firmware\Doc mplabx\build_xc8 \
	; main.c Alarma.c Aplicacion.c Buzzer.c Cluster.c DS1307.c EEprom.c \
	; I2C.c LedLive.c Serial.c TimeBase.c
	;
